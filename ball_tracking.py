...
def process_video(input_video, output_video_nb, output_video_contours, lower_bound, upper_bound):
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            #frame_with_contours = cv2.drawContours(frame, contours, -1, (0,0,255), 3) #cette version dessine tous les contours
...
def main(): 
    ...
    output_video_nb = 'videos/output_nb.mp4'
    output_video_contours = 'videos/output_cnt.mp4'
    ...
    process_video(input_video, output_video_nb, output_video_contours, lower_bound, upper_bound)
